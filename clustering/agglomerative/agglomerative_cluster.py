...
class AWardPBetaCluster(AgglomerativeCluster):
    ...
    def set_points_and_update(self, points_indices):
        """Add points to the cluster and update it. The centroid will be updated only if
        fix_centroid is set to False. Weights will be updated anyway.
        ...
        # weights update
        # (as per 7 in "A-Ward p b : Effective hierarchical clustering using the
